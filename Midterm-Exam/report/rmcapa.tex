...
\author{A report by \\ \\ \spacedlowsmallcaps{Soumya Subhra Banerjee}\\\spacedlowsmallcaps{Department of ECE,}\\ \spacedlowsmallcaps{Indian Institute of Science.}} % The article author(s) - author affiliations need to be specified in the AUTHOR AFFILIATIONS block
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.5]{outline.png}

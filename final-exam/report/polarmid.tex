...
\begin{figure}[h]
 \begin{center}
    \includegraphics[width=0.8\textwidth]{FERSW_0p04.png}
  \end{center}
...
\begin{figure}[h]
 \begin{center}
    \includegraphics[width=0.8\textwidth]{FERSW_0p15.png}
  \end{center}
...
\begin{figure}[h]
 \begin{center}
    \includegraphics[width=0.8\textwidth]{FERSW_0p2.png}
  \end{center}
...
\begin{figure}[h]
 \begin{center}
    \includegraphics[width=0.8\textwidth]{FERSW_0p25.png}
  \end{center}
...
\begin{figure}[h]
 \begin{center}
    \includegraphics[width=0.9\linewidth]{ratelosssw.png}
  \end{center}
